...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # contenido 
        self.label = tk.Label(self, text="Este es el menu principal", font = controller.title_font)
        ...
        self.direccionar = tk.Label(self, text=self.controller.ruta_carpeta)
        #direccionar.config(text="hola")

        button_buscar = tk.Button(self, text="Seleccionar Carpeta", command= lambda: self.seleccionar_carpeta(self.direccionar))
        button_crear = tk.Button(self, text = "Crear carpeta",
                                command=lambda: controller.show_frame("Crear"), state="disabled")
        button_go = tk.Button(self, text="Entrar", command=lambda: controller.show_frame("Ir"))
        self.direccionar.pack()
        button_buscar.pack()
        button_crear.pack()
        button_go.pack()
    ...
    def update(self):
        #print("hola")
        self.controller.ruta_carpeta = self.direccionar.cget('text')
